    ...
    <tbody>
        @foreach ($users as $user)
            <tr>
                ...
                <td>{{ $user->email }}</td>
                <td>
                    <a href="{{ route('admin.users.edit', $user->id) }}">Düzenle</a>
                </td>
            </tr>
        @endforeach
    </tbody>
...
<div class="info">
<a href="#" class="d-block">Ali Karahalilöz</a>
</div>
</div>
...
<li class="nav-item">
<a href="/adminusersindex" class="nav-link active">
<i class="far fa-circle nav-icon"></i>
<p>Users</p>
</a>
</li>
<li class="nav-item">
<a href="/adminusersmessage" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>Messages</p>
</a>
</li>
